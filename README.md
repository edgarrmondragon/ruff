...
| S324 | UseOfInsecureHash | Use of weak ... hash for security. Consider passing `usedforsecurity=False`. |  |
| S506 | UseOfYamlLoad | Use of unsafe `yaml.load`. Allows instantiation of arbitrary objects. Consider `yaml.safe_load`. |  |
